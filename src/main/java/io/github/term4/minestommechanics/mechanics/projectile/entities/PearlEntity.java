 ...
 * {@code teleportDamage} fall damage to a player shooter (vanilla 5). Vanilla 1.8 ignores hits on the shooter (the pearl passes through), wired via
...
public class PearlEntity extends ManagedProjectile {
    ...
    /** Fall damage dealt to a player shooter on landing (config {@code teleportDamage}, vanilla 5). */
